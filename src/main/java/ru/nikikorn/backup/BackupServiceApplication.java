...
public class BackupServiceApplication {
    ...
    private static Integer backupCicleSize; //- кол-во циклов создания backup директорий (по умолчанию: 3)
    ...
    public static void main(String[] args) throws IOException {
        ...
        //берем данные из файла конфиг.тхт
        System.out.println(properties.getProperty("backupCicleSize"));
        try {
